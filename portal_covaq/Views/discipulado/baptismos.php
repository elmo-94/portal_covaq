                                                ...
                                                foreach($this->dados2 as $row){?>                                                
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            ...
                                                            <input type="button" class="btn-editar" value="Editar" onclick="Javascript: location.href='<?php echo $pach?>baptismo/novo&id=<?php echo $row->id_bap; ?>#bg'">
                                                             
                                                            <input type="button" class="btn-deletar" value="Excluir" onclick="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) location.href='<?php echo $pach?>baptismo/eliminar&cod=<?php echo $row->id_bap; ?>'">
