...
<body>
        ...
        <main >
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">                                
                                <div class="card-body-header">
                                    <a href="#bg" class="btn-novo">Registar nova conta</a>

                                    <table>
                                        <td col-index = 2>Conta
                                                ...
                                                foreach($this->dados2 as $row){  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            ...
                                                            <input type="button" class="btn-editar" value="Editar" onclick="Javascript: location.href='<?php echo $pach?>contas/novo&id=<?php echo $row->id_conta; ?>#bg'">
                                                             
                                                            <input type="button" class="btn-deletar" value="Excluir" onclick="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) location.href='<?php echo $pach?>contas/eliminar&cod=<?php echo $row->id_conta; ?>'">
            ...
            <div class="container">
                ...
                <form action="<?php echo $pach?>contas/cadastrar" method="POST">
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <select name="cmbTipo" id="" class="dropdown">
                                ...
                                <option value="A pagar" <?php if(isset($_REQUEST['id'])) echo 'A pagar' == $dadosModel->tipo ? 'selected' : '' ?>>A pagar</option>
                        ...
                        <div class="input-box">
                            ...
                            <select name="cmbEstado" id="" class="dropdown">
                                ...
                                <option value="Atrasada" <?php if(isset($_REQUEST['id'])) echo 'Atrasada' == $dadosModel->estado ? 'selected' : '' ?>>Atrasada</option>
                            </select>
                        </div>
