    ...
    <div id="login-form" class="login-page">
        <div class="form-box">
            ...
            <form method="POST" action="<?php echo $pach?>home/login" id="login" class="input-group-login" >
                <div>
                    <input type="text" value=""   name="email" class="input-field" placeholder="Usuário ou Email" require>
                ...
                <div>
                    <input type="submit" name="portal" value="Portal" onclick="Javascript: location.href='<?php echo $pach?>portal'">
                </div>
