                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">                                
                                <div class="card-body-header">
                                    <a href="#bg" class="btn">Nono ministério</a>
                                    <div class="card-body-busca">
                                        <form class="form-busca" method="POST" action="<?php echo($pach)?>min/buscar&texto=<?php if(isset($_POST['btn-buscar'])){ echo $_POST['busca']; }?>">
                                                ...
                                                foreach($this->dados2 as $row){ ?>
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            ...
                                                            <input type="button" class="btn-editar" value="Editar" onclick="Javascript: location.href='<?php echo $pach?>min/novo&id=<?php echo $row->id_min; ?>#bg'">
                                                             
                                                            <input type="button" class="btn-deletar" value="Excluir" onclick="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) location.href='<?php echo $pach?>min/eliminar&cod=<?php echo $row->id_min; ?>'">
