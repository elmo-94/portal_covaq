    ...
    <div class="container-completo">
               ...
               <div  class="title-form">
                   ...
                   <div class="tab-header">
                       <button id="brn-tab1" class="btn-tab active" data-target-tab="#pessoais"><img src="<?php echo $pach?>img/user2.png" alt=""><span>Dados Pessoais</span> </button>
                       <button id="brn-tab2" class="btn-tab" data-target-tab="#add"><img src="<?php echo $pach?>img/location.png" alt=""><span>Adicionais</span> </button>
                       <button id="brn-tab3" class="btn-tab" data-target-tab="#memb"><img src="<?php echo $pach?>img/membrasia.png" alt=""><span>Membrasia</span> </button>
                       <button id="brn-tab4" class="btn-tab" data-target-tab="#min"><img src="<?php echo $pach?>img/min.png" alt=""><span> Ministérios</span> </button>
                       <button id="brn-tab5" class="btn-tab" data-target-tab="#financ"><img src="<?php echo $pach?>img/finanças.png" alt=""><span>Formação e Finanças</span> </button>
                       <button id="brn-tab6" class="btn-tab" data-target-tab="#foto"><img src="<?php echo $pach?>img/image1.png" alt=""><span>Carregar Foto</span> </button>
                   </div>
   
                       <form name="frmCad_membros" action="<?php echo $pach?>membros/cadastrar" method="POST" enctype="multipart/form-data" class="form" onsubmit="return validarCampos()">
                               ...
                               <div class="tab-content active" id="pessoais">
                                   ...
                                   <div class="user-details">    
                                       ...
                                       <div class="input-box">
                                           ...
                                           <input type="text" name="pai" value="<?php if(isset($_REQUEST['id'])) echo $dadosModel->pai ?>" placeholder="João Fernando" required>
                                       </div>
   
                                       <div class="input-box">
                                           <span class="details">Nome da mãe *</span>
                                           <input type="text" name="mae" value="<?php if(isset($_REQUEST['id'])) echo $dadosModel->mae ?>" placeholder="Ex: Maria José" required>
                                       </div>
                                   ...
                                   <div class="user-details">
                                       ...
                                       <div class="input-box">
                                           ...
                                           <select name="estatus" id="estatus" class="dropdown" onchange="habilitarCampos()">
                                               ...
                                               <option value="Filho" <?php if(isset($_REQUEST['id'])) echo 'Filho' == $estatus ? 'selected' : '' ?>>Filho</option>
                                   ...
                                   <div class="user-details" id="tab_memb">
                                       ...
                                       <div class="input-box">
                                           ...
                                           <select name="id_camp" id="" class="dropdown" required>
                                               <option value="">Selecione</option>
                                               <option value= "Igreja local" <?php if(isset($_REQUEST['id']) && isset($id_camp)) echo 'Igreja local' == 'Igreja local' ? 'selected' : 'Igreja local' ?> >Igreja local</option>
                                               <?php 
                                       ...
                                       <div class="input-box">
                                           ...
                                           <select name="classe_disc" id="area_discipulado" class="dropdown" onchange="habilitarCampos()">
                                               <option value="">Selecione</option>
                                               <option value="Discipulador" <?php if(isset($_REQUEST['id'])) echo 'Discipulador' ==  $discipulador ? 'selected' : '' ?>>Discipulador</option>
                                               <option value="Discipulo" <?php if(isset($_REQUEST['id'])) echo 'Discipuloo' == '' ? 'selected' : '' ?>>Discipulo</option>
                                           </select>
                                       </div>
                               ...
                               <div class="tab-content" id="financ">
                                   <div class="user-details">
                                       ...
                                       <div class="input-box">
                                           ...
                                           <select name="nivel" id="" class="dropdown" required>
                                               <option value="">Selecione</option>
                                       ...
                                       <div class="input-box">
                                           ...
                                           <input type="text" name="especialidade" value="<?php if(isset($_REQUEST['id'])) echo $especialidade ?>" placeholder="Ex: Médica" required>
                                       </div>
   
                                       <div class="input-box">
                                           <span class="details">Instituição *</span>
                                           <input type="text" name="instituicao" value="<?php if(isset($_REQUEST['id'])) echo $instituicao ?>" placeholder="Ex: Instituto Superior de Ciências Médicas" required>
                                       </div>
                                   ...
                                   <div class="image-box">
                                       ...
                                       <div class="input-box">
                                           ...
                                           <?php if(isset($_REQUEST['id']) &&  !empty($dadosModel->foto)){?>
                                               <img src="<?php echo($pach).'img/fotos/'.$dadosModel->foto; ?>" alt="" width="200px" height="200px" class="imagem" style="background-color: #ccc;"> 
           ...
           <script>
               ...
               function habilitarCampos(){
                   ...
                   if(area_discipulado.value == "Discipulo"){
...
;
       ...
       <script>
            ...
            var tabPage = document.querySelectorAll(".tab-content");

            function showPanel(panelIndex){
                
                tabPage.forEach(function (node){
                node.style.backgroundColor = "";
                ode.style.color= "";

                });
                btnTab[panelIndex].style.backgroundColor=colorCode;
                btnTab[panelIndex].style.color="write";
                tabPage.forEach(function(node){
                    node.style.display="none";
                });
                tabPage[panelIndex].style.display="block";
                tabPage[panelIndex].style.backgroundColor=colorCode;
                alert();
            }
            showPanel(0);
        </script>
