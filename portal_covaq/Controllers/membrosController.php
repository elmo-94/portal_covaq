...
class membrosController extends Controller{
    ...
    public function consultar(){
        ...
        if(isset($_POST['texto'])){
            $instModel = $this->Model->consultar($_POST['texto']); 
            $this->carregarTemplate('admin/consultaMembros',  array(), $instModel); 
        }else{
            $this->carregarTemplate('admin/consultaMembros', array(), array()); 
        }    
    ...
    public function cadastrar(){ 
        ...
        if($estado == true){
            if($this->Model->id_mem > 0 ){
                ...
                $this->carregarTemplate('admin/consultaMembros', $aviso, $dados);
            }else{
                $aviso[1] = 'O seu registo foi efectuado com sucesso !';
    ...
    public function upload_arquivo(){
        ...
        if(isset($_FILES['arquivo'])){
            ...
            $diretorio = "C:/xampp/htdocs/app_covaq/img/fotos/"; //define o directorio para onde sera guardado o arquivo
    ...
    public function validarCampos(){
        ...
        if(isset($formulario)){
            ...
            if(isset($formulario['nome'])):
                $erro['nome_erro'] = 'Preencha o campo nome';
            endif;
