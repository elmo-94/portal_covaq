                                             ...
                                             $total=0;
                                                foreach($this->dados2 as $row){  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>    
                                                            <!--<a href=""><img src="<?php echo $pach?>img/ver.png" alt="" width="24px" height="26px"></a> &nbsp;-->
                                                            <a href="<?php echo $pach?>dizimos/novo&id=<?php echo $row->id_diz; ?>#bg" ><img src="<?php echo $pach?>img/editarr.png" alt="" width="20px" height="24px"></a>
                                                            <a href="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) 
                                                                    location.href='<?php echo $pach?>dizimos/eliminar&cod=<?php echo $row->id_diz; ?>'"><img src="<?php echo $pach?>img/delete.png" alt="" width="24px" height="24px">
                                                            </a>  
                                                        </td>
                                                    </tr>
                                                ...
                                                foreach($this->dados as $row){                                                    
                                                    ...
                                                    <td> <?php echo $row->data_reg; ?></td>
                                                        ...
                                                        <td> 
                                                            <!--<a href=""><img src="<?php echo $pach?>img/ver.png" alt="" width="24px" height="26px"></a> &nbsp;-->
                                                            <a href="<?php echo $pach?>dizimos/novo&id=<?php echo $row->id_diz; ?>#bg" ><img src="<?php echo $pach?>img/editarr.png" alt="" width="24px" height="24px"></a>
                                                            <a href="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) 
                                                                    location.href='<?php echo $pach?>dizimos/eliminar&cod=<?php echo $row->id_diz; ?>'"><img src="<?php echo $pach?>img/delete.png" alt="" width="24px" height="24px">
                                                            </a>  
