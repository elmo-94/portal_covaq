                            ...
                            <div class="card-body">                                
                                <div class="card-body-header">
                                    ...
                                    <div style="display: flex; margin-top:1rem">
                                        ...
                                        <form class="form-busca" method="POST" action="<?php echo($pach)?>saidas/buscar">
                                             ...
                                             $total=0;
                                                foreach($this->dados2 as $row){  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <!--<a href="<?php echo $pach?>saidas/infor&id=<?php echo $row->id_saida; ?>#bg"> 
                                                                <img src="<?php echo $pach?>img/ver.png" alt="" width="24px" height="26px">
                                                            </a> &nbsp;-->
                                                            <a href="<?php echo $pach?>saidas/novo&id=<?php echo $row->id_saida; ?>#bg"> 
                                                            ...
                                                            <a href="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) 
                                                                    location.href='<?php echo $pach?>saidas/eliminar&cod=<?php echo $row->id_saida; ?>'">
