...
<table>
    ...
    foreach($consulta as $row){               
            ...
            <td> <?php echo $row->data_reg; ?></td>
                ...
                <td> 
                <a href="<?php echo $pach?>matrimonios/novo&id=<?php echo $row->id_; ?>#bg"> 
                ...
                <a href="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) 
                        location.href='<?php echo $pach?>matrimonios/eliminar&cod=<?php echo $row->id_mat; ?>'">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">                                
                                <div class="card-body-header">
                                    ...
                                    <div style="display: flex;" class="no-smarth">
                                            <div>
                                    ...
                                    <div class="card-body-busca">
                                        <form class="form-busca" method="POST" action="<?php echo($pach)?>matrimonios/buscar">
