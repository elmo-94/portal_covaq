                                             ...
                                             $total=0;
                                                foreach($this->dados2 as $row){?>                                                
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <a href="<?php echo $pach?>turmas/novo&id=<?php echo $row->id_turma; ?>#bg"> 
                                                                <img style="border-radius: 50%;" src="<?php echo $pach?>img/editarr.png" alt="" width="24px" height="24px">
                                                            </a>
                                                            <a href="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) location.href='<?php echo $pach?>turmas/eliminar&cod=<?php echo $row->id_turma; ?>'">
                        ...
                        <div class="input-box">
                            ...
                            <select name="id_prof" id="" class="dropdown">
                                ...
                                foreach($this->Model->carregarDiscipuladores() as $row){?>          
                                    <option value="<?php echo $row->id_discip; ?>"<?php  if(isset($_REQUEST['id'])) echo $row->id_discip == $dadosModel
