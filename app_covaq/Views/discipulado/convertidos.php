                                             ...
                                             $total=0;
                                                foreach($this->dados2 as $row){?>                                                
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <a href="<?php echo $pach?>convertidos/novo&id=<?php echo $row->id_nc; ?>#bg"> 
                                                                <img style="border-radius: 50%;" src="<?php echo $pach?>img/editarr.png" alt="" width="24px" height="24px">
                                                            </a>
                                                            <a href="Javascript: if(confirm('Tem certeza que deseja deletar este registo ?')) location.href='<?php echo $pach?>convertidos/eliminar&cod=<?php echo $row->id_nc; ?>'">
